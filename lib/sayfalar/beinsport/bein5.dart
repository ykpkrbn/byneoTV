...
class Bein5 extends StatelessWidget {
  const Bein5({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      stream: FirebaseFirestore.instance
          .collection('beinsport5').orderBy('kanal_adi',descending: true)
          .snapshots(),
            ...
            return InkWell(
              ...
              child: Card(
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      Image.asset('assets/sport/beinsport5.png'),
