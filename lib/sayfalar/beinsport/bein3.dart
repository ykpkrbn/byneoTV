...
class Bein3 extends StatelessWidget {
  const Bein3({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return  StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
      stream: FirebaseFirestore.instance
          .collection('beinsport3').orderBy('kanal_adi',descending: true)
          .snapshots(),
            ...
            return InkWell(
              ...
              child: Card(
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      Image.asset('assets/sport/beinsport3.png'),
